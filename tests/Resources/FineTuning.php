...
use RAGFlow\Responses\FineTuning\RetrieveJobResponseHyperparameters;
...
test('create job', function () {
    $client = mockClient('POST', 'fine_tuning/jobs', [
        ...
        'suffix' => null,
    ], \RAGFlow\ValueObjects\Transporter\Response::from(fineTuningJobCreateResource(), metaHeaders()));
...
test('list jobs', function () {
    $client = mockClient('GET', 'fine_tuning/jobs', [], \RAGFlow\ValueObjects\Transporter\Response::from(fineTuningJobListResource(), metaHeaders()));
...
test('list jobs with params', function () {
    $client = mockClient('GET', 'fine_tuning/jobs', ['limit' => 3], \RAGFlow\ValueObjects\Transporter\Response::from(fineTuningJobListResource(), metaHeaders()));
...
test('retrieve job', function () {
    $client = mockClient('GET', 'fine_tuning/jobs/ftjob-AF1WoRqd3aJAHsqc9NY7iL8F', [], \RAGFlow\ValueObjects\Transporter\Response::from(fineTuningJobRetrieveResource(), metaHeaders()));
...
test('cancel job', function () {
    $client = mockClient('POST', 'fine_tuning/jobs/ftjob-AF1WoRqd3aJAHsqc9NY7iL8F/cancel', [], \RAGFlow\ValueObjects\Transporter\Response::from([...fineTuningJobRetrieveResource(), 'status' => 'cancelled'], metaHeaders()));
...
test('list job events', function () {
    $client = mockClient('GET', 'fine_tuning/jobs/ftjob-AF1WoRqd3aJAHsqc9NY7iL8F/events', [], \RAGFlow\ValueObjects\Transporter\Response::from(fineTuningJobListEventsResource(), metaHeaders()));
    ...
    expect($result->data[0])
        ...
        ->level->toBe(\RAGFlow\Enums\FineTuning\FineTuningEventLevel::Info)
...
test('list job events with params', function () {
    $client = mockClient('GET', 'fine_tuning/jobs/ftjob-AF1WoRqd3aJAHsqc9NY7iL8F/events', ['limit' => 3], \RAGFlow\ValueObjects\Transporter\Response::from(fineTuningJobListEventsResource(), metaHeaders()));
