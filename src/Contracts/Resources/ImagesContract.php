...
interface ImagesContract
{
     ...
     *
     * @see https://ragflow.io/docs/dev/http_api_reference#images/create
     *
     ...
     *
     * @see https://ragflow.io/docs/dev/http_api_reference#images/create-edit
     *
     * @param  array<string, mixed>  $parameters
     */
     ...
     *
     * @see https://ragflow.io/docs/dev/http_api_reference#images/create-variation
     *
     * @param  array<string, mixed>  $parameters
     */
