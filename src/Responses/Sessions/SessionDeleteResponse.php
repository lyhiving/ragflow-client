 ...
 * @FilePath: /RAGFlow-php-client/src/Responses/Sessions/SessionDeleteResponse.php
 * @Description: 
 ...
 */
final class SessionDeleteResponse implements ResponseContract, ResponseHasMetaInformationContract
{
    /**
