 ...
 */
final class SessionListResponse implements ResponseContract, ResponseHasMetaInformationContract
{
    /**
    ...
    {
        $data = array_map(fn (array $result): SessionResponse => SessionResponse::from(
            $result,
            $meta,
        ), $attributes['data']);
    ...
    public function toArray(): array
    {
        return [
            'object' => $this->object,
            'data' => array_map(
                static fn (SessionResponse $response): array => $response->toArray(),
                $this->data,
            ),
